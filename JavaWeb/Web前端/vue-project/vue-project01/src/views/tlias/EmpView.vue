        ...
        <el-main>
          ...
          <el-form :inline="true" :model="searchItem" class="demo-form-inline">
            <el-form-item label="姓名">
              <el-input v-model="searchItem.user" placeholder="姓名"></el-input>
            </el-form-item>
            <el-form-item label="性别">
              <el-select v-model="searchItem.region" placeholder="性别">
                <el-option label="男" value="1"></el-option>
                <el-option label="女" value="2"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="入职日期">
              <el-date-picker v-model="searchItem.entrydate" type="daterange" range-separator="至" start-placeholder="开始日期"
          ...
          <el-table :data="tableData" border>
            ...
            <el-table-column label="图像" width="180">
              <template slot-scope="scope">
                <img v-bind:src="scope.row.image" width="100px">
              </template>
            </el-table-column>
